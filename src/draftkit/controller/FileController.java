...
public class FileController {
    ...
    // THIS GUY KNOWS HOW TO EXPORT DRAFT PAGE
     ...
     */
    public void markAsEdited(DraftKit_GUI gui) {
     ...
     * @param gui The user interface editing the Draft.
     */
    public void handleNewDraftRequest(DraftKit_GUI gui) {
        try {
     ...
     * @param gui The user interface editing the Draft.
     */
    public void handleLoadDraftRequest(DraftKit_GUI gui) {
        try {
            // WE MAY HAVE TO SAVE CURRENT WORK
     ...
     */
    public void handleSaveDraftRequest(DraftKit_GUI gui, Draft draftToSave) {
        try {
            // SAVE IT TO A FILE
     ...
     * @param gui
     */
    public void handleExportDraftRequest(DraftKit_GUI gui) {
     ...
     * @param gui
     */
    public void handleExitRequest(DraftKit_GUI gui) {
        try {
            // WE MAY HAVE TO SAVE CURRENT WORK
     ...
     */
    private boolean promptToSave(DraftKit_GUI gui) throws IOException {
     ...
     */
    private void promptToOpen(DraftKit_GUI gui) {
